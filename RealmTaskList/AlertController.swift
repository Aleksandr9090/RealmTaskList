...
extension UIAlertController {
    static func createAlertController(withTitle title: String, andMessage: String) -> UIAlertController {
        UIAlertController(title: title, message: andMessage, preferredStyle: .alert)
    }
